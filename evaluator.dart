...
// //     final value = evaluate(node.value as ast.ASTNode, env);
// //     if (value != null) {
...
//     // Ensure we store function parameters in the environment when calling the function
//     if (function is Functions) {
//         final extendedEnv = _extend_function_env(function, args);
//         env!.extend(extendedEnv);
//     }
//     return _apply_function(function!, args as List<Object>);
// }
